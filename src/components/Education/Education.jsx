...
export default function Education() {
  ...
  return (
    <section id="education" className="section bg-[#0b0b0f] relative">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-8">
        ...
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {education.map((edu, i) => (
            ...
            >
              ...
              <h3 className="text-white font-bold text-base leading-tight mb-1">{edu.degree}</h3>
              <p className="text-gold text-xs font-medium mb-1">{edu.institution}</p>
              <p className="text-[#7a7a8c] text-xs mb-4">{edu.location}</p>
              ...
              {/* Grade */}
              <div className="bg-[#18181f] rounded-xl p-4 mb-4">
                <p className="text-[#4a4a5c] text-[10px] mb-1 uppercase tracking-wider">Grade / Marks</p>
                <p className="text-white font-extrabold text-xl">{edu.grade}</p>
              </div>

              <p className="text-[#7a7a8c] text-xs leading-relaxed">{edu.description}</p>
            </div>
          ))}
        </div>
        ...
        >
          ...
          <div className="text-center md:text-left">
            <h3 className="text-white font-bold text-xl mb-2">Academic Excellence</h3>
